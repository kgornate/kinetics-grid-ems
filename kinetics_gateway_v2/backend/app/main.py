...
app = FastAPI(
    ...
    version="2.1.0-readonly-complete",
    description=(
        "FRDM i.MX93 BMS/PCS gateway with complete multi-rate extraction, delta WebSockets, "
        "JWT security, compressed SQLite historian, SD-card quota management, mock/hardware modes"
    ),
    lifespan=lifespan,
)
