...
echo "enabled=${SOLIS_RTU_ENABLED:-0} configured_port=${SOLIS_RTU_PORT:-/dev/ttyUSB0} stable_link=${SOLIS_RTU_STABLE_LINK:-/dev/ems_solis_rtu} unit_id=${SOLIS_RTU_UNIT_ID:-1} baud=${SOLIS_RTU_BAUDRATE:-9600}"
ls -l ${SOLIS_RTU_PORT:-/dev/ttyUSB0} ${SOLIS_RTU_STABLE_LINK:-/dev/ems_solis_rtu} 2>/dev/null || true
